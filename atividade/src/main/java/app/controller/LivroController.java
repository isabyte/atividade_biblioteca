...
public class LivroController {
	...
	public ResponseEntity<String> save(@RequestBody Livro livro) {
		try {
			...
			return new ResponseEntity<>("Erro ao salvar livro" + e.getMessage(), HttpStatus.BAD_REQUEST);
		}
	}
	...
	public ResponseEntity<String> update(@RequestBody Livro livro, @PathVariable long id) {
		try {
			...
			return new ResponseEntity<>("Erro ao atualizar livro" + e.getMessage(), HttpStatus.BAD_REQUEST);
		}
	}
	...
	public ResponseEntity<String> delete(@PathVariable long id) {
		try {
			...
			return new ResponseEntity<>("Erro ao deletar livro" + e.getMessage(), HttpStatus.BAD_REQUEST);
		}
	}
