...
public class BibliotecaController {
	...
	public ResponseEntity<String> save(@RequestBody Biblioteca biblioteca) {
		try {
			...
			return new ResponseEntity<>("Erro ao salvar biblioteca. " + e.getMessage(), HttpStatus.BAD_REQUEST);
		}
	}
	...
	public ResponseEntity<String> update(@RequestBody Biblioteca biblioteca, @PathVariable long id) {
		try {
			...
			return new ResponseEntity<>("Erro ao atualizar biblioteca. " + e.getMessage(), HttpStatus.BAD_REQUEST);
		}
	}
	...
	public ResponseEntity<String> delete(@PathVariable long id) {
		...
		try {
			...
			return new ResponseEntity<>("Erro ao deletar biblioteca. " + e.getMessage(), HttpStatus.BAD_REQUEST);
		}
