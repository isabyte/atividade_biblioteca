...
public class EditoraController {
	...
	public ResponseEntity<String> save(@RequestBody Editora editora) {
		try {
			...
			return new ResponseEntity<>("Erro ao salvar editora" + e.getMessage(), HttpStatus.BAD_REQUEST);
		}
	}
	...
	public ResponseEntity<String> update(@RequestBody Editora editora, @PathVariable long id) {
		try {
			...
			return new ResponseEntity<>("Erro ao atualizar editora" + e.getMessage(), HttpStatus.BAD_REQUEST);
		}
	}
	...
	public ResponseEntity<String> delete(@PathVariable long id) {
		try {
			...
			return new ResponseEntity<>("Erro ao deletar editora" + e.getMessage(), HttpStatus.BAD_REQUEST);
		}
	}
